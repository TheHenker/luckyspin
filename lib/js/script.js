...
function onloadCallback() {
    grecaptcha.render('faucetClaimCaptcha', {
        'sitekey' : '6LfRwyMTAAAAAM5lD_ZnGfbYYXh82eIuUMKA1n4t',
...
$(function(){
    ...
    $(".login_button").click(function(){
        if(user.connected){
            ...
            window.location.href = "https://blog.moneypot.com/oauth/authorize?app_id=1323&response_type=token&state=Meh&redirect_uri=http://thehenker.github.io/luckyspin/";
        }
    });
